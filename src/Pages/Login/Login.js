...
function Login() {
  ...
  const handleLogin = () => {
    if (email !== "") {
      setLoading(true);
      Axios.post(`${Axios.defaults.baseURL}/auth/login`, { email: email })
        .then((res) => {
          console.log(res);
          setLoading(false);
          startTimer();
  ...
  const handleOtp = () => {
    if (
      ...
      setLoading(true);
      console.log(parseInt(`${one}${two}${three}${four}${five}${six}`));
      Axios.post(`${Axios.defaults.baseURL}/verify-otp/login`, {
        email: email,
  ...
  // const generateMaskedEmai = (emailToMasked) => {
  //   return
  // };
            ...
            <div className={style.imagContainer}>
              <div className={style.imageTextContainer}>
                <div className={style.imageText}>
                  Aliquam auctor enim in tortor luctus, eu faucibus velit
                  mattis. Phasellus sed bibendum justo. Suspendisse felis lorem,
                  maximus sit amet imperdiet ut, molestie quis nunc.
                </div>
                <div className={style.dashContainer}>
                  <div
                    className={`${style.imageDash} ${
